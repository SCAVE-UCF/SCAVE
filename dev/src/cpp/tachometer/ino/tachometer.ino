...
void setup()
{
	...
	attachInterrupt(digitalPinToInterrupt(interruptPin), rpm_fun, FALLING); //interrupt triggers on pin 2,goes to rpm_fun when pin 2 goes low
																			// or attachInterrupt(0, rpm_fun, FALLING);
